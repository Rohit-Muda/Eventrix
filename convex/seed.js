...
Continental breakfast included in registration.`,
    ...
    city: "Hyderabad",
    state: "Telangana",
    venue: "https://maps.google.com/?q=91springboard+Hyderabad",
    address: "91springboard, Sector 44, Hyderabad",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 299,
    coverImage:
...
Lunch and refreshments included. Bring your laptop!`,
    ...
    city: "Hyderabad",
    state: "Telangana",
    venue: "https://maps.google.com/?q=Innov8+Cyber+Hub+Hyderabad",
    address: "Innov8 Coworking, Cyber Hub, DLF Cyber City, Hyderabad",
    capacity: 40,
    ticketType: "paid",
    ticketPrice: 1499,
    coverImage:
...
Continental breakfast and unlimited coffee included!`,
    ...
    city: "Hyderabad",
    state: "Telangana",
    venue: "https://maps.google.com/?q=WeWork+Two+Horizon+Center+Hyderabad",
    address: "WeWork Two Horizon Center, Golf Course Road, Hyderabad",
    capacity: 35,
    ticketType: "paid",
    ticketPrice: 399,
    coverImage:
...
Snacks and beverages provided both days.`,
    ...
    city: "Hyderabad",
    state: "Telangana",
    venue: "https://maps.google.com/?q=Visual+Arts+Gallery+Hyderabad",
    address: "Visual Arts Gallery, Sector 44, Hyderabad",
    capacity: 20,
    ticketType: "paid",
    ticketPrice: 2499,
    coverImage:
  ...
  },
  {
    ...
    description: `The biggest corporate cricket showdown in Hyderabad is back!
...
Perfect for team building and corporate bonding!`,
    ...
    city: "Hyderabad",
    state: "Telangana",
    venue: "https://maps.google.com/?q=Tau+Devi+Lal+Stadium+Hyderabad",
    address: "Tau Devi Lal Stadium, Sector 38, Hyderabad",
    capacity: 180,
    ticketType: "paid",
    ticketPrice: 500,
    coverImage:
...
Healthy snacks and herbal teas included.`,
    ...
    city: "Hyderabad",
    state: "Telangana",
    venue: "https://maps.google.com/?q=The+Yoga+Studio+Hyderabad",
    address: "The Yoga Studio, South City 2, Hyderabad",
    capacity: 25,
    ticketType: "paid",
    ticketPrice: 899,
    coverImage:
  ...
  },
  {
    ...
    address:
      "32nd Avenue - NH 48, Sector 15 Part 2, Sector 15, Hyderabad, Telangana 122001",
    capacity: 10,
    ticketType: "free",
    coverImage:
  ...
  },
  {
    ...
    address:
      "Google Office - Tower A, IN-GUR-SIGA, Sector 15 Part 2, Village Silokhera, Hyderabad, Telangana 122001",
    capacity: 75,
    ticketType: "paid",
    ticketPrice: 250,
    coverImage:
